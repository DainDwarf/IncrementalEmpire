...
export default Service.extend({
  ...
  async generate() {
    ...
    ach.reopen({condition: gte('game.empire.turn', 100)})
    this.achievements.push(ach)
    ...
    ach.reopen({condition: gte('game.empire.population', 10)})
    this.achievements.push(ach)
    ...
    ach.reopen({condition: gte('game.empire.population', 100)})
    this.achievements.push(ach)
    ...
    ach.reopen({condition: gte('game.empire.population', 1000)})
    this.achievements.push(ach)
